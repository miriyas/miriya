    ...
    <main className={styles.profile}>
      <div className={styles.centering}>
        ...
        <p>
          ...
          <LinkExternal href='https://miriyas.tistory.com/category/%EA%B7%B8%EB%A6%BC%EA%B7%B8%EB%A6%AC%EA%B8%B0'>
            그림
          </LinkExternal>
        ...
        <p>
          ...
          <br />
          공동저자로&nbsp;
          <LinkExternal href='https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=965523'>
            카페 운영 전략과 회원 관리하는 법에 대한 책
          </LinkExternal>
          을 낸 적도 있지요. <span>(품절 되었으니 링크 걸 수 있다 이제)</span> 다음 카페를 운영하다보니 자연스럽게&nbsp;
          <LinkExternal href='https://miriyas.tistory.com/'>블로그</LinkExternal>도 쓰게 되었습니다. Web2.0 시대,
        ...
        <p>
          ...
          <LinkExternal href='https://miriyas.tistory.com/15600916'>아이폰</LinkExternal>이 출시되고, UX 붐이 불었고, UX
          Factory 팀블로그에서도 활동하게 되었죠. 현재는 블로그는 사라지고&nbsp;
          <LinkExternal href='https://www.facebook.com/groups/189801707717156'>페이스북 그룹</LinkExternal>만
          남아있습니다. 그러다가&nbsp;
          <LinkExternal href='https://story.pxd.co.kr/550'>UX Camp Seoul 4th</LinkExternal>
        ...
        <p>
          ...
          <LinkExternal href='https://place.map.kakao.com/25977471'>&apos;환상의 드라이브 코스&apos;</LinkExternal>
        ...
        <p>
          ...
          <LinkExternal href='https://react.dev/'>React</LinkExternal>에 집중하고 있습니다. 저는 소위 말하는 뼛속 깊은
